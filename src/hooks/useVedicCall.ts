    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                ...
                "कल्याण हो! बेटा, जीवन कैसा चल रहा है? मैं एक आयुर्वेदाचार्य हूँ, इसलिए यदि आप चाहें तो अपनी शारीरिक या मानसिक पीड़ा मुझसे साझा करें। मैं शास्त्रों के अनुसार आपके मार्गदर्शन का प्रयास करूँगा।",
