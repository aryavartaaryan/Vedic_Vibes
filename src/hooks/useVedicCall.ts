...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव, यशस्वी भव! मेरी शिष्या तेजस्विनी ने मुझे आपके बारे में बताया था। बेटा, समय व्यर्थ नहीं गंवाना है। सीधे बताएं—क्या कोई शारीरिक कष्ट है या मन की कोई चिंता (Mental Stress)? मैं पूरा मार्गदर्शन करूँगा।",
                "कल्याण हो! मैं आचार्य प्रणव। बेटा, शरीर और मन का संतुलन ही जीवन है। आप मुझे खुलकर बताएं, अभी आपको कौन सी शारीरिक या मानसिक समस्या सता रही है? आप सही जगह आए हैं।",
                "आयुष्मान भव! बेटा, 'ओजस' की कमी दुख देती है। संकोच छोड़ें और सीधे बताएं—क्या शरीर में कोई रोग है या मन में कोई भारीपन? मैं आपके समाधान के लिए ही यहाँ हूँ।",
                "यशस्वी भव! मैं आचार्य प्रणव। बेटा, दुख छुपाने से बढ़ता है। मुझे अभी बताएं—क्या कोई शारीरिक व्याधि (Health Issue) है या कोई मानसिक तनाव? हम मिलकर अभी इसका मूल कारण खोजेंगे।",
                "कल्याण हो! बेटा, आप सही मार्गदर्शन के लिए आए हैं। इधर-उधर की बात नहीं करेंगे। बताइए, शरीर या मन में क्या कष्ट है? मैं पूरी तरह से आपकी सहायता के लिए प्रस्तुत हूँ।"
            ];
