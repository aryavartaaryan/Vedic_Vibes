...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव, यशस्वी भव! मैं आचार्य प्रणव हूँ। मेरी शिष्या तेजस्विनी ने मुझे आपके बारे में बताया था। बेटा, आपको कोई शारीरिक या मानसिक समस्या है तो कृपया अच्छे से बताएं, हम मिलकर उसका समाधान करेंगे।",
                "यशस्वी भव, आयुष्मान भव! मैं आचार्य प्रणव बोल रहा हूँ। बेटा, नि:संकोच कहो, क्या कोई शारीरिक या मानसिक कष्ट सता रहा है? हम मिलकर इसका हल निकालेंगे।",
                "कल्याण हो, यशस्वी भव! मैं आचार्य प्रणव हूँ। पुत्र, अपने स्वास्थ्य (शारीरिक या मानसिक) के बारे में खुलकर बताएं। हम ईश्वर की कृपा से इसका समाधान खोजेंगे।",
                "आयुष्मान भव, यशस्वी भव! मैं आचार्य प्रणव हूँ। बेटा, यदि कोई शारीरिक पीड़ा या मन की उलझन (मानसिक समस्या) है, तो मुझे बताएं। हम मिलकर इसे ठीक करेंगे।",
                "यशस्वी भव, आयुष्मान भव! मैं आचार्य प्रणव हूँ। घबराओ नहीं बेटा। बस यह बताओ, क्या कोई शारीरिक या मानसिक समस्या है? हम मिलकर इसका समाधान करेंगे।"
            ];
