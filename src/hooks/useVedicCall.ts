...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव! बेटा, जीवन कैसा चल रहा है? कोई भी शारीरिक या मानसिक कष्ट या समस्या है तो बताएं।",
                "कल्याण हो! बेटा, आज का दिन कैसा है? यदि कोई भी शारीरिक या मानसिक समस्या है, तो आप मुझे बता सकते हैं।",
                "यशस्वी भव! बेटा, क्या सब कुशल है? कोई भी शारीरिक या मानसिक कष्ट हो, तो संकोच न करें, खुलकर बताएं।",
                "आयुष्मान भव! बेटा, जीवन में उतार-चढ़ाव आते रहते हैं। यदि अभी कोई शारीरिक या मानसिक समस्या सता रही है, तो बताएं।",
                "कल्याण हो! बेटा, समय कैसा बीत रहा है? कोई भी शारीरिक या मानसिक कष्ट या समस्या है तो बताएं, हम उसका निवारण करेंगे।"
            ];
