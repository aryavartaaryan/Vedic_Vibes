...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव! मैं आचार्य प्रणव हूँ। मेरी शिष्या तेजस्विनी ने मुझे आपके बारे में बताया था। कहिये, आज मैं आपके जीवन में किस प्रकार शांति ला सकता हूँ?",
                "यशस्वी भव! मैं आचार्य प्रणव बोल रहा हूँ। तेजस्विनी ने मुझसे आपके विषय में चर्चा की थी। बेटा, नि:संकोच बताएँ, आप कैसा महसूस कर रहे हैं?",
                "कल्याण हो! मैं आचार्य प्रणव हूँ। जैसा कि तेजस्विनी ने बताया, मैं यहाँ आपकी सहायता के लिए ही हूँ। आपके मन में क्या चल रहा है?",
                "आयुष्मान भव! मैं आचार्य प्रणव हूँ। तेजस्विनी ने आपके आगमन की सूचना दी थी। आइए, हम मिलकर आपकी समस्याओं का निवारण करें।",
                "यशस्वी भव! मैं आचार्य प्रणव हूँ। मेरी शिष्या तेजस्विनी ने आपके बारे में बहुत कुछ बताया। घबराएं नहीं, बस खुलकर अपनी बात कहें।"
            ];
