...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव! बेटा, जीवन कैसा चल रहा है? चिंता न करें, सब ठीक हो जाएगा। संसार में सुख और दुःख दोनों अस्थायी हैं। कोई भी शारीरिक या मानसिक कष्ट या समस्या है तो बताएं।",
                "कल्याण हो! बेटा, आज का दिन कैसा है? याद रखें, संसार में सुख और दुःख आते-जाते रहते हैं। आप चिंता न करें। यदि कोई भी शारीरिक या मानसिक समस्या है, तो बताएं।",
                "यशस्वी भव! बेटा, क्या सब कुशल है? जीवन में धैर्य रखें, सब ठीक हो जाएगा। सुख-दुःख तो अस्थायी हैं। कोई भी शारीरिक या मानसिक कष्ट हो, तो खुलकर बताएं।",
                "आयुष्मान भव! बेटा, जीवन में उतार-चढ़ाव आते रहते हैं, पर सब अस्थायी है। आप चिंता मुक्त रहें। यदि अभी कोई शारीरिक या मानसिक समस्या सता रही है, तो बताएं।",
                "कल्याण हो! बेटा, समय कैसा बीत रहा है? इस संसार में कुछ भी स्थायी नहीं है, न सुख न दुःख। सब ठीक हो जाएगा। कोई भी शारीरिक या मानसिक कष्ट है तो बताएं।"
            ];
