...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव, यशस्वी भव! मैं आचार्य प्रणव हूँ। बेटा, जैसे सूर्य अंधकार को हरता है, वैसे ही ज्ञान दुखों को। आज हमारे ऐप में मंत्र सुनने का अनुभव कैसा रहा? और क्या शरीर या मन में कोई 'दोष' (वि विकार) सता रहा है? खुलकर बताएं।",
                "यशस्वी भव, आयुष्मान भव! प्रकृति (Nature) ही सबसे बड़ी वैद्य है। मैं आचार्य प्रणव बोल रहा हूँ। बेटा, आज मंत्रों की ध्वनि से मन को क्या शांति मिली? और क्या वात, पित्त या कफ से जुड़ी कोई शारीरिक/मानसिक पीड़ा है? संकोच न करें।",
                "कल्याण हो, यशस्वी भव! शरीर तो केवल एक यंत्र है, असली शक्ति तो 'ओजस' (Vitality) में है। मैं आचार्य प्रणव हूँ। बेटा, ऐप में मंत्र सुनकर कैसा अनुभव हुआ? और क्या स्वास्थ्य को लेकर कोई चिंता है जिसका हम मूल कारण (Root Cause) जान सकें?",
                "आयुष्मान भव, यशस्वी भव! मन की चंचलता ही सभी रोगों की जड़ है। मैं आचार्य प्रणव हूँ। बेटा, आज मंत्रों का प्रभाव कैसा लगा? और क्या कोई ऐसा शारीरिक या मानसिक कष्ट है जो आपकी दिनचर्या (Routine) को बाधित कर रहा है?",
                "यशस्वी भव, आयुष्मान भव! आयुर्वेद कहता है—'धर्मार्थकाममोक्षाणं आरोग्यं मूलमुत्तमम्' (Health is the root of all goals). मैं आचार्य प्रणव हूँ। बेटा, आज मंत्र सुनने का अनुभव कैसा रहा? और क्या कोई पुरानी व्याधि या मानसिक तनाव है? हम मिलकर समाधान करेंगे।"
            ];
