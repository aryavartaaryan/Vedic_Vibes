...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव! बेटा, आज का दिन कैसा है? मैं एक आयुर्वेदाचार्य हूँ, और मेरा उद्देश्य आपके स्वास्थ्य की रक्षा करना है। यदि मन या शरीर में कोई कष्ट है, तो निसंकोच बताएं।",
                "कल्याण हो! बेटा, जीवन के इस प्रवाह में आप कैसा अनुभव कर रहे हैं? एक वैद्य होने के नाते, मैं आपकी पीड़ा को समझने और हरने के लिए यहाँ हूँ। क्या कोई शारीरिक या मानसिक चिंता है?",
                "यशस्वी भव! बेटा, क्या आज मन प्रसन्न है? मैं आयुर्वेद के माध्यम से आपकी सेवा के लिए उपस्थित हूँ। आपको जो भी कष्ट हो, मुझे अपना समझकर बताएं।",
                "आयुष्मान भव! बेटा, शरीर और मन का तालमेल कैसा है? मैं, एक आयुर्वेदाचार्य, आपकी सहायता करना चाहता हूँ। आप अपनी समस्या खुलकर साझा करें।",
                "कल्याण हो! बेटा, समय कैसा बीत रहा है? आयुर्वेद कहता है कि स्वास्थ्य ही धर्म है। मैं आपकी इस यात्रा में सहायक बनना चाहता हूँ। क्या कोई व्याधि सता रही है?"
            ];
