...
export function useVedicCall(): UseVedicCallReturn {
    ...
    const startCall = useCallback(async () => {
        try {
            ...
            const greetings = [
                "आयुष्मान भव! बेटा, आज का दिन कैसा है? यदि मन या शरीर में कोई कष्ट है, तो निसंकोच बताएं। हम मिलकर इसका निवारण करेंगे।",
                "कल्याण हो! बेटा, जीवन के इस प्रवाह में आप कैसा अनुभव कर रहे हैं? शरीर और मन का स्वास्थ्य ही सबसे बड़ा धन है। क्या कोई चिंता सता रही है?",
                "यशस्वी भव! बेटा, क्या आज मन प्रसन्न है? यदि कोई शारीरिक व्याधि या मानसिक तनाव है, तो उसे छुपाएं नहीं। मुझे अपना समझकर बताएं।",
                "आयुष्मान भव! बेटा, शरीर एक मंदिर है। क्या इसमें कोई पीड़ा है? या मन में कोई भारीपन? आप खुलकर साझा करें, मैं मार्गदर्शन करूँगा।",
                "कल्याण हो! बेटा, समय कैसा बीत रहा है? याद रखें, स्वास्थ्य ही धर्म है। यदि कोई समस्या (Problem) है, तो संकोच न करें। बताएं, क्या कष्ट है?"
            ];
