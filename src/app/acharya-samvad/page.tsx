                            ...
                            {messages.length === 0 && (
                                <div className={styles.welcomeMessage}>
                                    <p className={styles.welcomeText}>
                                        {lang === 'hi'
                                            ? 'आयुष्मान भव! यशस्वी भव! बेटा, उम्मीद है कि मंत्रों और स्तोत्रों की पावन ध्वनि को सुनकर आपका चित्त शांत और प्रसन्न हुआ होगा। आपको वह अनुभव कैसा लगा? शारीरिक और मानसिक स्वास्थ्य के लिए मैं आपको प्रतिदिन हमारे इस एप्लिकेशन के मंत्रों के साथ ध्यान करने की सलाह देता हूँ। अब बताओ बेटा, कैसे हो? जीवन कैसा चल रहा है? जो भी स्वास्थ्य या व्यक्तिगत समस्या है, बिना किसी संकोच के बताएं। चिंता न करें सब सही हो जाएगा।'
                                            : 'Ayushman Bhav! Yashasvi Bhav! Beta, I hope your mind has become calm and joyful after listening to the sacred sounds of mantras and stotras. How did you feel listening to them? For your physical and mental well-being, I recommend that you meditate daily using the mantras in our application. Now tell me beta, how are you? How is life going? Please tell me about any health or personal concerns you have without any hesitation. Do not worry, everything will be fine.'}
                                    </p>
                                </div>
                            )}
